...
export function Projects() {
  ...
  return (
    <section
      id="projects"
      className="py-16 sm:py-24 px-4 bg-background relative overflow-hidden"
    >
        ...
        <motion.div
         ...
         >
           ...
           <h2 className="text-3xl sm:text-5xl md:text-7xl font-black mb-8 tracking-tight text-foreground font-heading uppercase py-2 px-6 text-center mx-auto max-w-[95vw]">
             Mes Derniers <span className="bg-gradient-to-r from-primary to-blue-400 text-transparent bg-clip-text italic px-2"> Projets</span>
           </h2>
